...
#---------------JEDI resources-------------------------
export fv3_bundle=${FV3_BUNDLE:-/work/noaa/da/hailingz/jedi/src/fv3-bundle_202201}
export fv3_bundle_build=${FV3_BUNDLE_BUILD:-/work/noaa/da/hailingz/jedi/build/fv3-bundle_202201}
export JEDIsrc=${fv3_bundle}
export JEDIbin=${fv3_bundle_build}/bin
